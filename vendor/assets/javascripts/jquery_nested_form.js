(function($) {
  ...
  NestedFormEvents.prototype = {
    addFields: function(e) {
      ...
      field
        .trigger({ type: 'nested:fieldAdded', field: field, new_id: new_id, parentIds: parentIds })
        .trigger({ type: 'nested:fieldAdded:' + assoc, field: field, new_id: new_id, parentIds: parentIds });
      return false;
    },
    newId: function() {
